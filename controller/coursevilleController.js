...
const access_token_url = "https://www.mycourseville.com/api/oauth/access_token";     //url ที่เอาไว้ access token ของ mcv
...
exports.getCourseAssignments = (req, res) => {
  ...
  try {
    ...
    const profileReq = https.request(
      `https://www.mycourseville.com/api/v1/public/get/course/assignments?cv_cid=${cv_cid}`,    //meaning of this line ??
      profileOptions,
      (profileRes) => {
        let profileData = "";
        profileRes.on("data", (chunk) => {
